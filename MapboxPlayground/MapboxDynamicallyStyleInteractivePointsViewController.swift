//
//  MapboxDynamicallyStyleInteractivePointsViewController.swift
//  MapboxPlayground
//
...
class MapboxDynamicallyStyleInteractivePointsViewController: MapboxBaseViewController {
    ...
    func addItemsToMap(features: [MGLPointFeature]) {
        ...
        style.setImage(UIImage(named: "custom_annotation_view_icon.png")!, forName: "lighthouse")
