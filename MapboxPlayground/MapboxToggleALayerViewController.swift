//
//  MapboxToggleALayerViewController.swift
//  MapboxPlayground
//
...
class MapboxToggleALayerViewController: MapboxBaseViewController {
    ...
    func addToggleButton() {
        ...
        button.addTarget(self, action: #selector(MapboxToggleALayerViewController.toggleLayer(sender:)), for: .touchUpInside)
